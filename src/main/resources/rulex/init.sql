CREATE TABLE IF NOT EXISTS `et_scene` (
  ...
  `scene_status` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '场景状态: 0 disabled 1 enabled',
...
CREATE TABLE IF NOT EXISTS `et_scene_action` (
  `id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` varchar(32) NOT NULL DEFAULT '' COMMENT '系统标识',
  `scene_id` bigint(32) NOT NULL COMMENT '对应场景id',
  `scene_code` varchar(64) NOT NULL DEFAULT '' COMMENT '对应场景code',
  ...
  `deleted_at` datetime NOT NULL DEFAULT '1970-01-01 08:00:00' COMMENT '删除时间',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uniq_scene_action`(`scene_code`, `action_code`) USING BTREE,
  KEY `idx_action_code`(`action_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='场景动作';

CREATE TABLE IF NOT EXISTS `et_scene_rule` (
  `id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` varchar(32) NOT NULL DEFAULT '' COMMENT '系统标识',
  `scene_id` bigint(32) NOT NULL COMMENT '对应场景id',
  ...
  `deleted_at` datetime NOT NULL DEFAULT '1970-01-01 08:00:00' COMMENT '删除时间',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uniq_scene_code_rule_code`(`scene_code`, `rule_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='场景规则';

CREATE TABLE IF NOT EXISTS `et_scene_rule_expr` (
  `id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` varchar(32) NOT NULL DEFAULT '' COMMENT '系统标识',
  `scene_id` bigint(32) NOT NULL COMMENT '对应场景id',
  `scene_code` varchar(64) NOT NULL DEFAULT '' COMMENT '对应场景code',
  ...
  `expr_val` varchar(512) NOT NULL DEFAULT '' COMMENT '值',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT '1970-01-01 08:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `deleted_at` datetime NOT NULL DEFAULT '1970-01-01 08:00:00' COMMENT '删除时间',
  PRIMARY KEY (`id`),
  KEY `idx_scene` (`scene_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='场景规则表达式';

CREATE TABLE IF NOT EXISTS `et_scene_var` (
  `id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` varchar(32) NOT NULL DEFAULT '' COMMENT '系统标识',
  `scene_id` bigint(32) NOT NULL COMMENT '对应场景id',
  ...
  `deleted_at` datetime NOT NULL DEFAULT '1970-01-01 08:00:00' COMMENT '删除时间',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uniq_scene_var` (`scene_code`, `var_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='场景变量';